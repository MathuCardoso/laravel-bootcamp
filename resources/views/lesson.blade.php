...
<x-layout>
    ...
    <aside>
        <div class="bg-white rounded-2xl shadow p-6">
            ...
            <ul class="space-y-2">
                <li><a href="#"
                       class="text-indigo-600 hover:underline">1. Introdução</a></li>
                <li><a href="#"
                       class="text-indigo-600 hover:underline">2. Instalação</a></li>
                <li><a href="#"
                       class="text-indigo-600 hover:underline">3. Eloquent ORM</a></li>
                <li><a href="#"
                       class="text-indigo-600 hover:underline">4. Blade Templates</a></li>
            </ul>
        </div>
    </aside>
</x-layout>
